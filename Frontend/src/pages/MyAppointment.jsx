          ...
          {patientAppointmentData && patientAppointmentData.slice().reverse().map((item) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2 justify-end">
                ...
                {!item.appointmentData.cancel && item.appointmentData.payment && !item.appointmentData.isCompleted && (
                  <>
                    ...
                    <button className="text-sm text-center min-w-48 py-2 border rounded border-yellow-500 text-yellow-500 transition-all duration-300">
                      Diagnosis Pending
                    </button>
                  </>
                )}
        ...
        >
          <div className="bg-white rounded-lg p-8 w-80 shadow-md">
            <h2 className="text-lg font-semibold">
              {modalAction === 'cancel' ? 'Cancel Appointment' : 'Payment Confirmation'}
            </h2>
